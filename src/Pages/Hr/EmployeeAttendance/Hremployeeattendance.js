...
import Graph from "../../Admin/Attendance/Graph/Graph";
...
const Attendance = () => {
  ...
  const handleEditRecord = (id) => {
    Navigate(`/hreditattendance/${id}`);
  };
  const handleAddAttendance = (id) => {
    Navigate(`/hraddattendance`);
  };
                        ...
                        <td>
                          {editRecordId === record.id ? (
                            <input
                              ...
                              onChange={(e) => handleSaveCommen("in_time", e)}
                        ...
                        <td>
                          {editRecordId === record.id ? (
                            <input
                              ...
                              onChange={(e) => handleSaveCommen("out_time", e)}
                              className="form-control"
                            />
                          ) : (
                        ...
                        <td>
                          {editRecordId === record.id ? (
                            <input
                              ...
                              onChange={(e) => handleSaveCommen("date", e)}
                              className="form-control"
                            />
                          ) : (
                        ...
                        <td>
                          {editRecordId === record.id ? (
                            <select
                              ...
                              onChange={(e) => handleSaveCommen("status", e)}
                              className="form-control"
                            >
                              {status.map((s, i) => (
            ...
            <div className="card-container">
              {tableLoading ? (
                <div className="text-center py-4">
                  <ClipLoader color="#FE7743" size={40} speedMultiplier={1.2} />
                </div>
              ) : attendanceData.length > 0 ? (
                attendanceData.map((record) => (
