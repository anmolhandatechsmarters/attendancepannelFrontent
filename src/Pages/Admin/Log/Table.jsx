...
const convertTo12HourFormat = (time) => {
  ...
  // Format the time correctly without duplicating AM/PM
  const formattedTime = `${normalizedHours}:${minutes}:${seconds} ${modifier}`;

  return formattedTime; // Return the correctly formatted time
};
const Log = () => {
  ...
  return (
    <>
      <div className="upperdiv mb-0">
        ...
        <div className="row gy-3 align-items-center mt-3 ">
          <div className="col-12 col-md-4">
            {selectedLogs.length > 0 && (
              <button
                onClick={handleMultipleDelete}
                className="button-log-delete-button"
              >
                Delete log
              </button>
            )}
